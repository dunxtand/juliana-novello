 ...
 * @return mixed
 */
function tail_base_remove_query_string_version($src)
{
...
if (!is_admin()) {
    ...
    add_filter('style_loader_src', 'tail_base_remove_query_string_version', 9999);

    // Remove Wp version from scripts
    add_filter('script_loader_src', 'tail_base_remove_query_string_version', 9999);
}
/*
|--------------------------------------------------------------------------
| Custom Login Error Message
...
function tail_base_custom_login_error_message()
{
    return __('Oops! Incorrect input', 'tail-base');
}

add_filter('login_errors', 'tail_base_custom_login_error_message');
